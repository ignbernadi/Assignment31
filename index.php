...
<div class="container">
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <div class="item">
        <img src="images/ldr5.jpg" alt="Too the moon" style="width:100%;">
        <div class="carousel-caption">
          <h3>LDR LA to the Moon Tour</h3>
          <p>I love you to the moon and back</p>
        </div>
      </div>

      <div class="item">
        <img src="images/ldr6.jpg" alt="Too the moon" style="width:100%;">
        <div class="carousel-caption">
          <h3>Hello Hollywood !</h3>
